...
exports.Experience = [{
  ...
  roles: ["Collaborate with AWS service teams to onboard, deploy, and operate services in the European Sovereign Cloud region.", "Provide on-call operational support to maintain high availability and reliability of services in EUSC.", "Investigate, debug, and resolve service issues, contributing to root cause analysis and long-term improvements."]
}, {
  svg: "rosenxt.svg",
...
exports.Projects = [{
  ...
  date: "December 2025",
  award: null,
  flavor: "Quickly analyze photos EXIF metadata and check camera shutter counts online.",
  repo: null,
  external: "https://shutter-count-project.vercel.app",
  details: ["Build the interface with NextJS.", "Implement the API that extracts EXIF metadata.", "Deploy the project on Vercel."]
}, {
  name: "StoryAI",
  color: "#2f74fc",
  image: "storyai.png",
  ...
  details: ["Build the game with NextJS.", "Integrate LLM to generate parts of the story.", "Deploy the project on Vercel."]
}, {
  name: "Ninja Coder",
  color: "#fa8211",
...
exports.Social = [{
  ...
  link: "https://github.com/aymen-bs"
}, {
  name: "LinkedIn",

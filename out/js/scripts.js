...
exports.Experience = [{
  ...
  roles: ["Collaborated closely with cross-functional teams to integrate cutting-edge AI technology into the platform.", "Actively participated in code reviews, testing, and debugging processes to maintain high-quality standards and deliver a reliable product to users."]
}, {
  svg: "aws.svg",
  ...
  flavor: "Expensya is a Web and Mobile solution that automates expense reports management for professionals.",
  roles: ["Data mining for OCR dataset.", "Dashboard implementation for data visualization for OCR dataset.", "Outliers detection."]
}, {
  svg: "tplus.svg",

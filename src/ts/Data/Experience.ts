...
export const Experience: ExperienceData[] = [
  ...
  },
  {
    ...
    roles: [
      "Backend development with Spring Boot framework and MongoDB.",
      "Frontend development with Angular.",
    ],
  },
  {
    ...
    flavor:
      "For my summer internship, I have participated in Orange Summer Challenge program (OSC) in partnership with Google. \n" +
  ...
  },
  {
    ...
    roles: [
      "Backend development with Express.js and MongoDB.",
      "OCR microservice development with Tesseract python.",
      "Dashboard development with React.",
    ],
  },
];
